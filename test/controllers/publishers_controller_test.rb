...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { name: @publisher.name, user_id: @publisher.user_id } }, as: :json
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { name: @publisher.name, user_id: @publisher.user_id } }, as: :json
    assert_response 200
  end
